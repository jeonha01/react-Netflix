            ...
            <Container fluid>
                ...
                <Navbar.Collapse id="navbarScroll">
                    <Nav
                        ...
                        navbarScroll
                    >
                        <Nav.Link className="Button" href="/">Home</Nav.Link>
                        <Nav.Link className="Button" href="movies">Movies</Nav.Link>
